...
echo "Restart mysql..."
sudo mysql -e "use mysql; update user set authentication_string=PASSWORD('pwd') where User='root'; update user set plugin='mysql_native_password';FLUSH PRIVILEGES;"
